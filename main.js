...
var $author$project$Main$credit = A2(
...
var $author$project$Main$renderUl = function (items) {
	return A2(
		$elm$core$List$map,
		function (link) {
			return A2(
...
var $author$project$Main$socials = _List_fromArray(
	[
		A2($author$project$Main$Link, 'twitch', 'https://twitch.tv/bashbunni'),
		A2($author$project$Main$Link, 'youtube', 'https://youtube.com/bashbunni'),
		A2($author$project$Main$Link, 'github', 'https://github.com/bashbunni'),
		A2($author$project$Main$Link, 'mastodon', 'https://mastodon.social/@bashbunni'),
		A2($author$project$Main$Link, 'twitter', 'https://twitter.com/sudobunni')
	]);
var $author$project$Main$links = function (_v0) {
	return A2(
		$elm$html$Html$ul,
		_List_fromArray(
			[
		...
		$author$project$Main$renderUl($author$project$Main$socials));
};
var $elm$html$Html$section = _VirtualDom_node('section');
var $author$project$Main$typing = function (_v0) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Main$typing(model),
				A2(
				...
				_List_fromArray(
					[
						$author$project$Main$links(model),
						$author$project$Main$about,
						$author$project$Main$interests
					])),
				$author$project$Main$credit
			]));
};
